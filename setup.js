...
console.log('Scaffolding Peeyush Kumar Interactive Portfolio...');
...
// Complete project files mapping
const files = {
  'package.json': `{
  "name": "peeyush-kumar-portfolio",
  "private": true,
  "version": "1.1.0",
  "type": "module",
  "scripts": {
...
/* Custom glow element utility */
.radial-glow {
  background: radial-gradient(circle 400px at var(--x, 0px) var(--y, 0px), rgba(20, 184, 166, 0.15), transparent 80%);
}`,
...
ReactDOM.createRoot(document.getElementById('root')).render(
  ...
  'src/components/SEO.jsx': `import React from 'react';
          ...
          <nav className="hidden md:flex space-x-8 text-xs font-mono uppercase tracking-widest">
            {['About', 'Skills', 'Experience', 'Contact'].map((item) => (
              <button
                ...
                className={\`transition-colors relative hover:text-teal-400 \${
...
console.log('\n--- Setup Successful ---');
console.log('Follow these console commands inside the directory to spin up:');
